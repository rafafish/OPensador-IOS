...
#define SHKFacebookKey				@"232525373450477"
#define SHKFacebookSecret			@"a2e3352628754f7070cf606ad23d00c3"
 ...
 */
#define SHKTwitterConsumerKey		@"JRJZ1OuxfuOhGYPlv1jWg"
#define SHKTwitterSecret			@"tjCjyhdrV7ZN1BctCCx9YOjRNu6Dt4YDdjkiDlb4"
#define SHKTwitterCallbackUrl		@"http://rafafishapps.com.br" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"rafafish" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
