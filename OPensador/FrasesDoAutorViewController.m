...
@implementation FrasesDoAutorViewController
...
- (IBAction)copiar:(id)sender{
    ...
    Frase *tFrase = (Frase *)[appDelegate.FrasesDoAutor objectAtIndex: appDelegate.AutorPaginaNumPag];
...
- (void)loadScrollViewWithPage:(int)page {
    ...
    FrasePaginaViewController *controller = [viewControllers objectAtIndex:page];
    if ((NSNull *)controller == [NSNull null]) {
        controller = [[FrasePaginaViewController alloc] initWithPageNumber:page];
...
- (void)scrollViewDidScroll:(UIScrollView *)sender {
 ...
 //   if (pageControlUsed) {
  ...
  //      OPensadorAppDelegate *appDelegate = (OPensadorAppDelegate *)[[UIApplication sharedApplication] delegate];
//        appDelegate.AutorPaginaNumPag = appDelegate.IndiceFraseDoAutor;
  //      return;
   // }
    ...
    appDelegate.AutorPaginaNumPag = pageControl.currentPage;
...
- (void)viewDidLoad
{
    ...
    NumPaginas = appDelegate.FrasesDoAutor.count;
