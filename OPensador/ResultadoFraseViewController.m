//
//  ResultadoFraseViewController.m
//  OPensador
//
...
@implementation ResultadoFraseViewController
...
- (IBAction)copiar:(id)sender{
    ...
    Frase *tFrase = (Frase *)[appDelegate.FrasesBusca objectAtIndex: appDelegate.BuscaPaginaNumPag];
    Autor *tAutor = (Autor *)[appDelegate.Autores objectAtIndex:[tFrase IdAutor]-1];
...
- (void)loadScrollViewWithPage:(int)page {
    ...
    ResultadoPaginaViewController *controller = [viewControllers objectAtIndex:page];
    if ((NSNull *)controller == [NSNull null]) {
        controller = [[ResultadoPaginaViewController alloc] initWithPageNumber:page];
...
- (void)scrollViewDidScroll:(UIScrollView *)sender {
 ...
 //       return;
  //  }
    ...
    appDelegate.BuscaPaginaNumPag = pageControl.currentPage;    
...
- (void)viewDidLoad
{
    ...
    OPensadorAppDelegate *appDelegate = (OPensadorAppDelegate *)[[UIApplication sharedApplication] delegate];
    NumPaginas = appDelegate.FrasesBusca.count;
    
    
    //Set the title
    self.navigationItem.title = appDelegate.palavraBusca;
    ...
    pageControl.currentPage = appDelegate.IndiceFraseBusca;
